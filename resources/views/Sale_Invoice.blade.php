...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">فواتير البيع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    الفواتير </span>
            </div>
            ...
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex justify-content-button">
								...
								<a href="{{ url('add_invoiceSale') }}" class="btn btn-xs btn-info pull-right">اضافة فاتورة</a>
