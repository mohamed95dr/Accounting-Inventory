                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"> يتعين قراءة
                                    الكل </span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 "> عدد الإشعارات الغير
                                مقروءة : {{ Auth()->user()->unreadNotifications->count() }}</p>
                        </div>
