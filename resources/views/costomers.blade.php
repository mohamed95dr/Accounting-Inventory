                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">إضافة الزبون</a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-phone="{{ $x->phone }}"
                                                    data-type="{{ $x->type }}" data-toggle="modal" href="#exampleModal2"
                                                    title="تعديل"><i class="las la-pen"></i></a>

                                                 <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-id="{{ $x->id }}" data-name="{{ $x->name }}" data-phone="{{ $x->phone }}" data-type="{{ $x->type }}" data-toggle="modal" 
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">اضافة الزبون</h6><button aria-label="Close" class="close" data-dismiss="modal"
